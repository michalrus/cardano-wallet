  ...
  extras = hackage:
    {
      packages = {
        ...
        "blockfrost-api" = (((hackage.blockfrost-api)."0.4.0.1").revisions).default;
        "blockfrost-client" = (((hackage.blockfrost-client)."0.4.0.1").revisions).default;
        "blockfrost-client-core" = (((hackage.blockfrost-client-core)."0.4.0.1").revisions).default;
